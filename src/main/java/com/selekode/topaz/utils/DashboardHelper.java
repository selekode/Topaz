...
public class DashboardHelper {
	public static String getJournalStreakParagraph(int journalStreak) {
		...
		if (journalStreak <= 1) {
			journalStreakParagraph = "- Aún no has conseguido una racha en tu diario. ¡Escribe varios dias seguidos para conseguirla!";
	...
	public static String getRevisionStreakParagraph(int revisionStreak) {
		...
		if (revisionStreak <= 1) {
			revisionStreakParagraph = "- Aún no has conseguido una racha de revisiones. ¡Escribe varios dias seguidos para conseguirla!";
